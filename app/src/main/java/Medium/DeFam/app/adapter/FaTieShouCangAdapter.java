...
public class FaTieShouCangAdapter extends RecyclerView.Adapter<FaTieShouCangAdapter.ViewHolder> {
    private final List<ShouCangFaTieBean.DataBean> dataList = new ArrayList<>();
    ...
    public FaTieShouCangAdapter(Context context) {
        this.context = context;
    }

    public void replaceAll(List<ShouCangFaTieBean.DataBean> list) {
        dataList.clear();
     ...
     * 不然容易出现闪动和间距错乱的问题
     */
    public void addData(List<ShouCangFaTieBean.DataBean> list) {
        dataList.addAll(list);
        notifyDataSetChanged();
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // 创建空布局item
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_fatieshoucang, parent, false));
    }

    @SuppressLint("RecyclerView")
    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        WenZhangDetailBean data = dataList.get(position).getAction_txt();
