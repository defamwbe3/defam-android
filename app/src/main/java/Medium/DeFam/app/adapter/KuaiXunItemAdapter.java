...
public class KuaiXunItemAdapter extends RecyclerView.Adapter {
    ...
    public KuaiXunItemAdapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
            // 创建空布局item
            return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_kuaixunitem, parent, false));
        } else {
            return new ViewHolder1(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_kuaixinitem1, parent, false));
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        switch (getItemViewType(position)) {
            case TYPE_ITEM:
                ...
                vh.created_at_top.setText(data.getCreated_at());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView title, is_top, comments, created_at,created_at_top;
        ...
        public ViewHolder(View view) {
            ...
            created_at_top = view.findViewById(R.id.created_at_top);
        }
    }
