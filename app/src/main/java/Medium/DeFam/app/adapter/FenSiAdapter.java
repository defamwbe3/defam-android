...
public class FenSiAdapter extends RecyclerView.Adapter<FenSiAdapter.ViewHolder> {
    private final List<FenSiBean.DataBean> dataList = new ArrayList<>();
    private Context context;
    private RecyclerView recyclerView;
    private OnRecyclerViewItemClickListener mOnItemClickListener = null;

    public interface OnRecyclerViewItemClickListener {
        void onItemClick(int pos, int type, FenSiBean.DataBean data);
    }
    ...
    public void replaceAll(List<FenSiBean.DataBean> list) {
        dataList.clear();
     ...
     * 不然容易出现闪动和间距错乱的问题
     */
    public void addData(List<FenSiBean.DataBean> list) {
        dataList.addAll(list);
        notifyDataSetChanged();
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // 创建空布局item
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_fensi, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        FenSiBean.DataBean data = dataList.get(position);
        ...
        holder.article_num.setText("作品："+data.getMember().getArticle_num());
