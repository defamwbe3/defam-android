...
import Medium.DeFam.app.adapter.KuaiXunItemAdapter;
...
public class KuaiXunItemFragment extends BaseFragment {

    public static KuaiXunItemFragment newInstance(String title,String category_id, boolean load) {
        KuaiXunItemFragment fragment = new KuaiXunItemFragment();
    ...
    public void initData() {
        ...
        adapter = new KuaiXunItemAdapter(getContext());
        adapter.setRecyclerViewOnItemClickListener(new KuaiXunItemAdapter.OnRecyclerViewItemClickListener() {
            @Override
