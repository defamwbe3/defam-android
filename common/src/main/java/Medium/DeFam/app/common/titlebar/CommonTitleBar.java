package Medium.DeFam.app.common.titlebar;
...
public class CommonTitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    private void loadAttributes(Context context, AttributeSet attrs) {
        ...
        titleBarColor = array.getColor(R.styleable.CommonTitleBar_titleBarColor, Color.parseColor("#00000000"));
        titleBarHeight = (int) array.getDimension(R.styleable.CommonTitleBar_titleBarHeight, ScreenUtils.dp2PxInt(context, 45));
        statusBarColor = array.getColor(R.styleable.CommonTitleBar_statusBarColor, titleBarColor);
        ...
        bottomLineColor = array.getColor(R.styleable.CommonTitleBar_bottomLineColor, Color.parseColor("#F0F1F9"));
        ...
        if (!TextUtils.isEmpty(leftText)) {
            ...
            leftTextSize = array.getDimension(R.styleable.CommonTitleBar_leftTextSize, ScreenUtils.dp2PxInt(context, 14));
        ...
        } else if (leftImageResource != 0) {
            leftType = TYPE_LEFT_IMAGEBUTTON;
        } else if (leftCustomViewRes != 0) {
            leftType = TYPE_LEFT_CUSTOM_VIEW;
        } else {
            leftType = TYPE_LEFT_NONE;
        }
        boolean myleftType = array.getBoolean(R.styleable.CommonTitleBar_leftType, false);
        if(myleftType){
            leftType = TYPE_LEFT_NONE;
        }
        ...
        if (!TextUtils.isEmpty(rightText)) {
            ...
            rightTextSize = array.getDimension(R.styleable.CommonTitleBar_rightTextSize, ScreenUtils.dp2PxInt(context, 15));
        } else if (rightImageResource != 0) {
            rightType = TYPE_RIGHT_IMAGEBUTTON;
        } else if (rightCustomViewRes != 0) {
            rightType = TYPE_RIGHT_CUSTOM_VIEW;
        } else {
            rightType = TYPE_RIGHT_NONE;
        }
        ...
        if (!TextUtils.isEmpty(centerText)) {
            ...
            centerSubTextColor = array.getColor(R.styleable.CommonTitleBar_centerSubTextColor, Color.parseColor("#333333"));
            centerSubTextSize = array.getDimension(R.styleable.CommonTitleBar_centerSubTextSize, ScreenUtils.dp2PxInt(context, 11));
        } else if (!centerSearchEditable) {
        ...
        } else if (centerCustomViewRes != 0) {
            centerType = TYPE_CENTER_CUSTOM_VIEW;
        } else {
            centerType = TYPE_CENTER_NONE;
        }
    ...
    private void initGlobalViews(Context context) {
        ...
        // 计算主布局高度
        if (showBottomLine) {
            mainParams.height = titleBarHeight - Math.max(1, ScreenUtils.dp2PxInt(context, 0.5f));
        } else {
        ...
        if (showBottomLine) {
            ...
            LayoutParams bottomLineParams = new LayoutParams(MATCH_PARENT, Math.max(1, ScreenUtils.dp2PxInt(context, 0.5f)));
    ...
    private void initMainLeftViews(Context context) {
        ...
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            ...
            tvLeft.setPadding(PADDING_12, PADDING_12, PADDING_12, PADDING_12);
           ...
           /* leftInnerParams.width = ScreenUtils.dp2PxInt(context, 30);
            leftInnerParams.height = ScreenUtils.dp2PxInt(context, 30);*/
            //rightInnerParams.setMargins(PADDING_12, 0, PADDING_12, 0);
    ...
    private void initMainRightViews(Context context) {
        ...
        /*    rightInnerParams.width = ScreenUtils.dp2PxInt(context, 45);
            rightInnerParams.height = ScreenUtils.dp2PxInt(context, 45);*/
            //rightInnerParams.setMargins(PADDING_12, 0, PADDING_12, 0);
    ...
    private void initMainCenterViews(Context context) {
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            //tvCenter.setTypeface(Typeface.SANS_SERIF, Typeface.BOLD);//加粗
...
//            }
    ...
    public void onClick(View v) {
        ...
        if (v.equals(llMainCenter) && doubleClickListener != null) {
        ...
        } else if (v.equals(tvLeft) || v.equals(btnLeft)) {
            listener.onClicked(v, ACTION_LEFT_BUTTON, null);
        } else if (v.equals(tvRight) || v.equals(btnRight)) {
            ...
            listener.onClicked(v, ACTION_CENTER_BUTTON, null);
        }
    }
...
//    public static final int ACTION_LEFT_TEXT = 1;        // 左边TextView被点击
    ...
    public static final int ACTION_CENTER_BUTTON = 9;     // 中间文字点击
